...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('karyawan.store') }}" method="POST" id="formCreate">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="email" class="form-control" placeholder="Masukkan Email" value="{{ old('email') }}" name="email" id="email" required>
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan Jabatan" value="{{ old('jabatan') }}" name="jabatan" id="jabatan" required>
                </div>
                <div class="form-group mb-3">
