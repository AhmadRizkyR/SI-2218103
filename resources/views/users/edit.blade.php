        ...
        <div class="card-body">
            <form action="{{ route('users.update', $user->id) }}" method="POST" id="formCreate">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan Nama" value="{{ $user->name }}" name="name" id="name" required>
                </div>
                <div class="form-group mb-3">
                    <label for="email">Email</label>
                    <input type="email" class="form-control" placeholder="Masukkan Email" value="{{ $user->email }}" name="email" id="email" required>
                </div>
                <div class="form-group mb-3">
