...
<!-- MODAL CREATE -->
<div class="modal fade" id="createSatuan" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body g-2">
                <form action="{{ route('satuan.store') }}" method="POST" id="formCreate">
                    @csrf
                    <div class="form-group mb-3">
                        <label for="name">Nama</label>
                        <input type="text" class="form-control" placeholder="Masukkan Nama Satuan" name="nama" id="nama" required>
                    </div>
                    <div class="form-group mb-3">
