            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a class="text-primary" href="{{ route('satuan.index') }}">Satuan</a>
                    </li>
        ...
        <div class="card-header">
            <div class="row g-2">
                <div class="col-12 col-md-4">
                    ...
                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#createSatuan">Tambah Data</button>
                </div>
                <div class="col-12 col-md-4">
                </div>
                <div class="col-12 col-md-4">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <button type="button" data-action="{{ route('satuan.update', $data->id) }}" data-content='{{ $data }}' class="btn btn-primary btn-sm btn-edit" data-bs-toggle="modal" data-bs-target="#modalSatuan"><i class="tf-icons bx bxs-edit"></i></button>
