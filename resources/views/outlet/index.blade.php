        ...
        <div class="card-header">
            <div class="row g-2">
                <div class="col-12 col-md-4">
                    <a href="{{ route('outlet.create') }}" class="btn btn-success">Tambah Data</a>
                </div>
                <div class="col-12 col-md-4">
                </div>
                <div class="col-12 col-md-4">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="{{ route('outlet.edit', $data->id) }}" class="btn btn-primary btn-sm"><i class="tf-icons bx bxs-edit"></i></a>
